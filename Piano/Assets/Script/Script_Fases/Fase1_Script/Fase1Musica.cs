...
public class Fase1Musica : MonoBehaviour
{
    ...
    public void Erros()
    {
            if(NotaDo == 1 && CountMusic !=1)
            {
                AddErro();
                Manager.V_Do_E();
                StartCoroutine(Timer());
            }
            if (NotaRe ==1 && CountMusic !=2)
            {
                 AddErro();
                 Manager.V_Re_E();
                 StartCoroutine(Timer());
             }
            else if (NotaMi == 1 && CountMusic != 3)
            {
                AddErro();
                Manager.V_Mi_E();
                StartCoroutine(Timer());
            ...
            else if (NotaSol == 1 && CountMusic != 5)
            {
                AddErro();
                Manager.V_Sol_E();
                StartCoroutine(Timer());
            }
            else if (NotaLa == 1 && CountMusic != 6)
            {
                AddErro();
                Manager.V_La_E();
                StartCoroutine(Timer());
            }
            else if (NotaSi == 1 && CountMusic != 7)
            {
                AddErro();
                Manager.V_Si_E();
                StartCoroutine(Timer());
