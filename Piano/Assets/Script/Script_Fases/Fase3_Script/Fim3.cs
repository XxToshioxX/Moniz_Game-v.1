...
public class Fim3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Facil
        {
            ...
            else if (PlayerPrefs.GetInt("Erros") > 1  && PlayerPrefs.GetInt("Erros") <= 4)
            {
                MuitoBom.SetActive(false);
            ...
            else if (PlayerPrefs.GetInt("Erros") > 4 && PlayerPrefs.GetInt("Erros") <= 6)
            {
            ...
            else if (PlayerPrefs.GetInt("Erros") > 6)
            {
