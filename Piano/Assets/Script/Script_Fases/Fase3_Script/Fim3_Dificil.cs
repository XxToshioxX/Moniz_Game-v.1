...
public class Fim3_Dificil : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        else if (PlayerPrefs.GetInt("Erros") > 0 && PlayerPrefs.GetInt("Erros") <= 8)
        {
            MuitoBom.SetActive(false);
        ...
        else if (PlayerPrefs.GetInt("Erros") > 2 && PlayerPrefs.GetInt("Erros") <= 12)
        {
        ...
        else if (PlayerPrefs.GetInt("Erros") > 12)
        {
