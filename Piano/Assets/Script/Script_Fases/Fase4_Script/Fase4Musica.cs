...
public class Fase4Musica : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (PlayerPrefs.GetInt("Fases") == 10 || PlayerPrefs.GetInt("Fases") == 11)
        {

            if (CountMusic == 12 && NotaFa == 1)
            {
                AddScore();
                Manager.V_Fa_A();
                CountMusic = 13;
    ...
    IEnumerator Timer() //Sumir Notas
    {
        ...
        else if (CountMusic == 18 && Trava == true)
        {
            Manager.V_Mi_A();
            Trava = false;
            if (PlayerPrefs.GetInt("Fases") == 10)
            {
                SceneManager.LoadScene(SceneWin);
            }
        }
    ...
    IEnumerator NotasMusicas() //Musica
    {
        ...
        Manager.V_Mi_P();
        //}
        yield return new WaitForSeconds(PausaNota);
        //////////////////////////////////////////////////////////////////////////
    ...
    public void Erros()
    {
        if (NotaDo == 1 && CountMusic != 9)
        {
            AddErro();
            Manager.V_Do_E();
            StartCoroutine(Timer());
        }
        if (NotaRe == 1 && CountMusic != 10 && CountMusic != 19 && CountMusic != 20 && CountMusic != 22)
        {
            AddErro();
            Manager.V_Re_E();
            StartCoroutine(Timer());
        }
        if (NotaMi == 1 && CountMusic != 1 && CountMusic != 2 && CountMusic != 3 && CountMusic != 4 && CountMusic != 5 && CountMusic != 6 && CountMusic != 7 && CountMusic != 11 && CountMusic != 15 && CountMusic != 16 && CountMusic != 17 && CountMusic != 18 && CountMusic != 21)
        {
            AddErro();
            Manager.V_Mi_E();
            StartCoroutine(Timer());
        }
        if (NotaFa == 1 && CountMusic != 12 && CountMusic != 13 && CountMusic != 14)
        {
            AddErro();
            Manager.V_Fa_E();
            StartCoroutine(Timer());
        }
        if (NotaSol == 1 && CountMusic != 8 && CountMusic != 23)
        {
            AddErro();
            Manager.V_Sol_E();
            StartCoroutine(Timer());
